...
namespace try_bi
{
    public partial class w_split_edc : Form
    {
        ...
        public void get_id_bank()
        {
            ...
            {
                ckon.sqlCon().Open();
                String cmd_bank1 = "SELECT * FROM bank WHERE BANK_NAME LIKE '%" + combo_bank1.Text + "%'";
                ...
                String cmd_bank2 = "SELECT * FROM bank WHERE BANK_NAME LIKE '%" + combo_bank2.Text + "%'";
                ...
                if (ckon.sqlDataRd.HasRows)
                {
                    while (ckon.sqlDataRd.Read())
                    {
                        id_bank2 = ckon.sqlDataRd["BANK_ID"].ToString();
                    }
                }
            }
            catch (Exception e)
        ...
        public void hitung()
        {
            String cmd_update = "UPDATE transaction SET DISCOUNT='"+ field_diskon2 +"',TOTAL='" + tot_bel + "', STATUS='1', PAYMENT_TYPE='3', EDC='" + edc1 + "', EDC2='"+ edc2 +"' ,BANK_NAME='" + id_bank + "',BANK_NAME2='"+ id_bank2 +"' ,NO_REF='" + t_rev.Text + "',NO_REF2='"+ t_rev2.Text +"'  WHERE TRANSACTION_ID ='" + id_trans + "'";
            CRUD edit = new CRUD();
