...
namespace try_bi
{
    public partial class MO_SearchArticle : Form
    {
        ...
        public void cek_article2()
        {
            ...
            try
            {
                ...
                command = "SELECT * FROM article INNER JOIN inventory "
                            + "ON inventory.ARTICLE_ID = article.ARTICLE_ID "
            ...
            //i = 0;
            //string sql = "SELECT * FROM mutasiorder_line WHERE MUTASI_ORDER_ID ='" + t_id + "' AND ARTICLE_ID='" + S_ID + "'";
            //ckon.cmd = new MySqlCommand(sql, ckon.con);
            //ckon.con.Open();
            //ckon.myReader = ckon.cmd.ExecuteReader();
            //int count = 0;
        ...
        public void save_trans_header()
        {
            ...
            //ckon.con.Close();
            //String sql0 = "SELECT * FROM mutasiorder WHERE MUTASI_ORDER_ID ='" + t_id + "'";
