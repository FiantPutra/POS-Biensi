...
namespace try_bi.Class
{
    class API_ReturnOrder
    {
        ...
        String store_code2, date2, remark2, id_r_o2, time2, timestamp2, warehouseid2, seq_number_substring, no_sj;
        ...
        public async Task<Boolean> returnOrder()
        {
            ...
            try
            {
                ...
                String cmd = "SELECT a.RETURN_ORDER_ID, a._id as RoId, a.STORE_CODE, a.DATE, a.REMARK, a.STATUS, a.TIME, a.TIME_STAMP, a.TOTAL_QTY, "
                                + "a.WAREHOUSE_ID, a.NO_SJ, c._id as ArtId, c.ARTICLE_ID, c.ARTICLE_NAME, c.ARTICLE_ID_ALIAS, c.PRICE, c.UNIT, "
                                ...
                                + "ON b.ARTICLE_ID = c.ARTICLE_ID WHERE a.STATUS_API = 0 AND a.STATUS = 1";
