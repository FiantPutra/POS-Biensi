...
namespace try_bi
{
    class NewFunctionPrinter
    {
        ...
        public void CreateReceipt(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            {
                ckon.sqlCon().Open();
                command = "SELECT transaction_line.ARTICLE_ID, transaction_line.QUANTITY, transaction_line.DISCOUNT, transaction_line.PRICE, transaction_line.SUBTOTAL,transaction_line.DISCOUNT_DESC, article.SIZE_ID " +
