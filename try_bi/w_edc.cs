...
namespace try_bi
{
    public partial class w_edc : Form
    {
        ...
        {
            String cmd_update = "UPDATE transaction SET  DISCOUNT ='"+ field_diskon2 +"',TOTAL='"+ total +"', STATUS='1', PAYMENT_TYPE='1', EDC='"+ total +"' ,BANK_NAME='"+ id_bank +"', NO_REF='"+ t_rev.Text +"'  WHERE TRANSACTION_ID ='" + id_trans + "'";
