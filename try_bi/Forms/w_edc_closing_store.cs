...
namespace try_bi
{
    public partial class w_edc_closing_store : Form
    {
        koneksi ckon = new koneksi();
        String nm_bank, date, nm_bank2, id_bank;
        int total_amount, total_edc2, fix_total;
        DateTime mydate = DateTime.Now;
        public string id_Cstore2;
        public w_edc_closing_store()
        {
            InitializeComponent();
        }
        ...
        public void total_bank(String tanggal)
        {
            ...
            try
            {
                ...
                if (ckon.sqlDataRdHeader.HasRows)
                {
                    while (ckon.sqlDataRdHeader.Read())
                    {
                        ...
                        String cmd_EDC1 = "SELECT SUM([transaction].EDC) as total FROM [transaction] WHERE BANK_NAME='" + id_bank + "'AND ID_C_STORE='" + id_Cstore2 + "' AND (STATUS='1' or STATUS='2')";
                        ...
                        String cmd_EDC2 = "SELECT SUM([transaction].EDC2) as total FROM [transaction] WHERE BANK_NAME2='" + id_bank + "' AND ID_C_STORE='" + id_Cstore2 + "' AND (STATUS='1' or STATUS='2')";
                        ckon.sqlDataRdLine = sql.ExecuteDataReader(cmd_EDC1, ckon.sqlCon());
            ...
            //        String sql2 = "SELECT SUM(transaction.EDC) as total FROM transaction WHERE BANK_NAME='" + id_bank + "' AND ID_C_STORE='" + id_Cstore2 + "' AND (STATUS='1' or STATUS='2')";
            ...
            //        ckon2.con2.Close();
            //        //=====================================================================================================
            //        String sql3 = "SELECT SUM(transaction.EDC2) as total FROM transaction WHERE BANK_NAME2='" + id_bank + "' AND ID_C_STORE='" + id_Cstore2 + "' AND (STATUS='1' or STATUS='2')";
        ...
        //=======================================================================================================================
        private void w_edc_closing_store_Load(object sender, EventArgs e)
        {
